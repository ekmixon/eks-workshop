...
def main(argv=None):
    ...
    print(f'Data: {data[:50]} ... {data[len(data)-52:]}')
    ...
    title = f'The model thought this was a {class_names[np.argmax(predictions[0])]} (class {test_labels[rando]}), and it was actually a {class_names[np.argmax(predictions[0])]} (class {test_labels[rando]})'
